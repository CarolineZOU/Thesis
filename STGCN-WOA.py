    ...
    for iter in range(max_iter):
        ...
        for whale in whales:
            ...
            if np.abs(A) < 1:
                ...
                rand_whale = whales[random.randint(0, num_whales-1)]
            ...
            final_pos = new_pos if np.random.rand() < 0.5 else new_pos_spiral
            final_pos = np.clip(final_pos, [
                param_ranges['hidden_dim'][0],
                param_ranges['dropout_rate'][0],
                param_ranges['lr'][0]
            ], [
                param_ranges['hidden_dim'][1],
            ...
            if new_fitness > whale['fitness']:
                whale.update({'position': final_pos, 'fitness': new_fitness})
...
if __name__ == "__main__":
    ...
    SAVE_DIR = "STGCN_WOA_models"
    OUTPUT_DIR = "STGCN_WOA_output"
